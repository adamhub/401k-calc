...
class Display extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      contribPercent: Number(cookies.get("contribPercent") || 25),
    ...
    this.handleAnnualSalarySliderChange =
      this.handleAnnualSalarySliderChange.bind(this);
    this.handleAnnualRaiseSliderChange =
      this.handleAnnualRaiseSliderChange.bind(this);
    ...
    this.handleCurrentBalanceSlider =
      this.handleCurrentBalanceSlider.bind(this);
    ...
    this.handleEmployerMatchCapSlider =
      this.handleEmployerMatchCapSlider.bind(this);
      ...
      >
        <Grid container>
          <Grid item xs={5} style={{ padding: "25px" }}>
            ...
            <AnnualSalaryIncreaseSlider
              slide={this.handleAnnualRaiseSliderChange}
            />
            ...
            {this.state.employerSetType == 0 ? (
              ...
              <EmployerMatchCapSlider
                slide={this.handleEmployerMatchCapSlider}
              />
            )}
          </Grid>
          <Grid item xs={7}>
            <BarChart
              matchData={createMatchDatapoints(this.state)}
              noMatchData={createNoMatchDatapoints(this.state)}
              labels={createLabels(this.state)}
            />
          </Grid>
        </Grid>
      </Paper>
